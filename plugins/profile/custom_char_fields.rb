  ...
  module Profile
    class CustomCharFields
      ...
      def self.get_fields_for_chargen(char)
        return { marque: Website.format_markdown_for_html(char.marque); scion: Website.format_markdown_for_html(char.scion) }
      end
      ...
      def self.save_fields_from_chargen(char, chargen_data)
        return [char.update(scion: chargen_data[:custom][:scion]); char.update(marque: chargen_data[:custom][:marque])]
      end
